...
void wxCEEDFInitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/bitmaps.cpp$D___Programming_Projects_C++_Personal Projects_AutoBackupper_AutoBackupperGUI_wxCrafter_bitmaps.xrc"), xml_res_file_0, xml_res_size_0, wxT("text/xml"));
    wxXmlResource::Get()->Load(wxT("memory:XRC_resource/bitmaps.cpp$D___Programming_Projects_C++_Personal Projects_AutoBackupper_AutoBackupperGUI_wxCrafter_bitmaps.xrc"));
}
